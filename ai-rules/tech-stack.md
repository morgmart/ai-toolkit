---
description: "Explain frontend/fullstack tech stack concepts to a product designer using plain language and design analogies (Figma, components, tokens, etc.)"
alwaysApply: false
---
